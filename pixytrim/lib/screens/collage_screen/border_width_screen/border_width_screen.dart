...
class BorderWidthScreen extends StatefulWidget {
 // const BorderWidthScreen({Key? key}) : super(key: key);
  //CollageScreenController collageScreenController;
  //BorderWidthScreen({required this.collageScreenController});

  @override
  _BorderWidthScreenState createState() => _BorderWidthScreenState();
}

class _BorderWidthScreenState extends State<BorderWidthScreen> {
